(() => {
  ...
  function MissingnessSim() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "sim-row" }, /* @__PURE__ */ React.createElement("div", { className: "sim-controls" }, /* @__PURE__ */ React.createElement("div", { className: "sim-ctrl" }, /* @__PURE__ */ React.createElement("label", null, "Pattern"), /* @__PURE__ */ React.createElement("div", { className: "seg" }, ["MCAR", "MAR", "MNAR"].map((p) => /* @__PURE__ */ React.createElement("button", { key: p, className: pattern === p ? "on" : "", onClick: () => setPattern(p) }, p)))), /* @__PURE__ */ React.createElement("p", { className: "prose", style: { fontSize: 12.5, margin: 0 } }, desc[pattern]), /* @__PURE__ */ React.createElement("div", { className: "sim-stats", style: { marginTop: 12 } }, COLS.map((c, i) => /* @__PURE__ */ React.createElement("div", { key: c }, /* @__PURE__ */ React.createElement("div", { className: "k" }, c), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: pctMissing[i] > 30 ? inkOf(color) : "inherit" } }, pctMissing[i], "%"))))), /* @__PURE__ */ React.createElement("div", { className: "plot-wrap", style: { overflowX: "auto" } }, /* @__PURE__ */ React.createElement("table", { style: {
        borderCollapse: "collapse",
        fontSize: 12,
        fontFamily: "'JetBrains Mono', monospace",
        minWidth: 380
      } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { style: { padding: "4px 8px", textAlign: "left", color: "#6A6270", fontWeight: 700, letterSpacing: "0.1em" } }, "#"), COLS.map((c) => /* @__PURE__ */ React.createElement("th", { key: c, style: { padding: "4px 8px", textAlign: "right", color: "#6A6270", fontWeight: 700 } }, c)))), /* @__PURE__ */ React.createElement("tbody", null, base.map((row, r) => /* @__PURE__ */ React.createElement("tr", { key: r, style: { borderTop: "1px solid #E8E2DA" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: "4px 8px", color: "var(--ink-3)" } }, r + 1), COLS.map((c) => {
  ...
  function LeakageDetector() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "sim-row", style: { flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 } }, FEATURE_POOL.map((f) => {
        ...
        setReveal(false);
      } }, "Reset"), revealed && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, color: leakyCount > 0 ? "var(--coral-ink)" : "var(--lime-ink)", fontFamily: "'JetBrains Mono', monospace" } }, leakyCount > 0 ? `${leakyCount} leaky feature${leakyCount > 1 ? "s" : ""} found` : "All clear")), revealed && leakyCount > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, selectedFeatures.filter((f) => f.leaky).map((f) => /* @__PURE__ */ React.createElement("div", { key: f.name, style: {
        background: "#FF6B8012",
        border: "1px solid #FF6B8040",
        borderLeft: "3px solid #FF6B80",
        borderRadius: 6,
        padding: "10px 14px"
      } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: "var(--coral-ink)", fontWeight: 700, marginBottom: 4 } }, f.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: "#3A3540" } }, f.reason)))), revealed && leakyCount === 0 && /* @__PURE__ */ React.createElement("div", { style: {
        background: "#D1FF3A10",
