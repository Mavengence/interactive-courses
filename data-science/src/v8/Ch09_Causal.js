(() => {
  ...
  function ConfoundingSimulator() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      )), /* @__PURE__ */ React.createElement("div", { className: "sim-stats", style: { marginTop: 12, gridTemplateColumns: "1fr" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "OVERALL r"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { fontSize: 24, color: "var(--pink)" } }, round(rAll, 2)), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "looks causal!")), revealed && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10 } }, rPerGroup.map((r, g) => /* @__PURE__ */ React.createElement("div", { key: g, style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: sc.zColors[g], fontFamily: "'JetBrains Mono',monospace" } }, sc.zGroups[g]), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontFamily: "'JetBrains Mono',monospace", color: "#C7C4BC" } }, "r = ", round(r, 2)))), /* @__PURE__ */ React.createElement("div", { className: "sub", style: { marginTop: 6 } }, "within-group r \u2248 0"))), /* @__PURE__ */ React.createElement("p", { className: "prose", style: { fontSize: 11.5, marginTop: 10, color: "#8A8680" } }, sc.zLab, " drives both axes. Remove its influence and the correlation vanishes.")), /* @__PURE__ */ React.createElement("div", { className: "plot-wrap" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${W} ${H}` }, /* @__PURE__ */ React.createElement("line", { x1: pad.l, y1: H - pad.b, x2: W - pad.r, y2: H - pad.b, stroke: "#4A4540", strokeWidth: "1" }), /* @__PURE__ */ React.createElement("line", { x1: pad.l, y1: pad.t, x2: pad.l, y2: H - pad.b, stroke: "#4A4540", strokeWidth: "1" }), /* @__PURE__ */ React.createElement(
        "text",
        {
          x: W / 2,
          y: H - 4,
  ...
  function DAGBuilder() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "sim-row", style: { gridTemplateColumns: "1fr 1fr" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "seg", style: { flexDirection: "column", gap: 4 } }, DAGS.map((d, i) => /* @__PURE__ */ React.createElement("button", { key: i, className: active === i ? "on" : "", onClick: () => setActive(i) }, d.title, " ", /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.55, fontSize: 10 } }, d.tag)))), /* @__PURE__ */ React.createElement("div", { style: {
        ...
        padding: "12px 14px",
        marginTop: 4
      } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#8A8680", fontFamily: "'JetBrains Mono',monospace", marginBottom: 6 } }, dag.question), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "#F4F2EC", marginBottom: 8 } }, dag.answer), /* @__PURE__ */ React.createElement("div", { style: {
        ...
        marginBottom: 8
      } }, dag.adjustIcon), /* @__PURE__ */ React.createElement("p", { className: "prose", style: { fontSize: 11.5, margin: 0, color: "#8A8680" } }, dag.explanation))), /* @__PURE__ */ React.createElement("div", { className: "plot-wrap" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${W} ${H}` }, /* @__PURE__ */ React.createElement("defs", null, ["arr9", "arr-red9", "arr-lime9"].map((id, idx) => {
  ...
  function InstrumentalVariable() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      )), /* @__PURE__ */ React.createElement("div", { className: "sim-stats", style: { gridTemplateColumns: "1fr 1fr", marginTop: 10 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "IV estimate"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { fontSize: 20, color: "#5B9BE8" } }, s.ivEst.toFixed(2)), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "bias: ", bias.toFixed(2))), showBias && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "OLS estimate"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { fontSize: 20, color: "#FF4DA2" } }, (trueEffect + s.olesBias).toFixed(2)), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "bias: ", s.olesBias.toFixed(2)))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, padding: "8px 10px", borderRadius: 6, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", fontSize: 11 } }, /* @__PURE__ */ React.createElement("div", { style: { color: "#8A8680", fontFamily: "'JetBrains Mono',monospace", marginBottom: 4 } }, "F-statistic (first stage)"), /* @__PURE__ */ React.createElement("div", { style: { color: s.fStat < 10 ? "#FF4DA2" : "#1FAF7E", fontWeight: 700, fontSize: 16, fontFamily: "'JetBrains Mono',monospace" } }, s.fStat, " ", s.fStat < 10 ? "\u26A0 weak" : "\u2713"), /* @__PURE__ */ React.createElement("div", { style: { color: "#8A8680", fontSize: 10, marginTop: 4 } }, "Rule of thumb: F > 10 for valid IV"))), /* @__PURE__ */ React.createElement("div", { className: "plot-wrap" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${W} ${H}` }, /* @__PURE__ */ React.createElement("defs", null, markerColors.map((c) => /* @__PURE__ */ React.createElement(
        "marker",
        {
          key: c,
          id: `iv-arr-${c.replace("#", "")}`,
