(() => {
  ...
  function LIMEExplainer() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      )), /* @__PURE__ */ React.createElement("div", { className: "sim-stats", style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "P(class B)"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: "#5B3EE8" } }, round(localExplanation.prob, 3))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "Local \u2202/\u2202x"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: a1 >= 0 ? "#1FAF7E" : "#D83A3A" } }, a1 >= 0 ? "+" : "", round(a1, 3))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "Local \u2202/\u2202y"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: a2 >= 0 ? "#1FAF7E" : "#D83A3A" } }, a2 >= 0 ? "+" : "", round(a2, 3)))), /* @__PURE__ */ React.createElement("p", { className: "prose", style: { fontSize: 11, marginTop: 8, lineHeight: 1.5 } }, Math.abs(a1) > Math.abs(a2) ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("strong", null, "Feature X"), " drives this prediction more than Y locally.") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("strong", null, "Feature Y"), " drives this prediction more than X locally."))), /* @__PURE__ */ React.createElement("div", { className: "plot-wrap", style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { className: "sim-plot-head" }, "Decision boundary", /* @__PURE__ */ React.createElement("span", { className: "hint" }, "class A (blue) \xB7 class B (pink) \xB7 locality circle (dashed)")), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${SW} ${SH}`, style: { width: "100%", cursor: "crosshair" } }, cells.map(({ cx, cy, p }, i) => {
  ...
  function PermutationImportance() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "sim-row" }, /* @__PURE__ */ React.createElement("div", { className: "sim-controls", style: { minWidth: 180 } }, /* @__PURE__ */ React.createElement("div", { className: "sim-stats" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "Baseline acc"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: "#1FAF7E" } }, PERM_BASELINE.toFixed(3))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "k" }, "Top feature"), /* @__PURE__ */ React.createElement("div", { className: "v", style: { color: "#E8A031", fontSize: 11 } }, results.reduce((a, b) => a.drop > b.drop ? a : b).label))), /* @__PURE__ */ React.createElement(
        "button",
        {
