(() => {
  ...
  function Bar({ label, value, max, color, annotation }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 3, color: "#d1d5db" } }, /* @__PURE__ */ React.createElement("span", null, label), /* @__PURE__ */ React.createElement("span", { style: { color, fontWeight: 600 } }, annotation || `${round(value, 1)}%`)), /* @__PURE__ */ React.createElement("div", { style: { height: 10, background: HAIR, borderRadius: 5, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { width: `${pct}%`, height: "100%", background: color, borderRadius: 5, transition: "width 0.5s ease" } })));
  }
  ...
  function CUPEDExplainer() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 24, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 200px", padding: 16, background: BGHT, borderRadius: 10, border: `1px solid ${HAIR}`, fontSize: 12.5, lineHeight: 1.8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono,monospace)", fontSize: 11, color: BLUE, marginBottom: 8 } }, "CUPED FORMULA"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono,monospace)", color: "#f1f5f9" } }, "\u03B8 = Cov(Y, X) / Var(X)", /* @__PURE__ */ React.createElement("br", null), "\u0176 = Y \u2212 \u03B8(X \u2212 X\u0304)"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, color: INK3, fontSize: 12 } }, /* @__PURE__ */ React.createElement("div", null, "\u03B8 estimated: ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#f1f5f9" } }, theta)), /* @__PURE__ */ React.createElement("div", null, "Var (raw): ", /* @__PURE__ */ React.createElement("strong", { style: { color: BAD } }, varRaw)), /* @__PURE__ */ React.createElement("div", null, "Var (CUPED): ", /* @__PURE__ */ React.createElement("strong", { style: { color: MINT } }, varCuped))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, padding: "8px 10px", background: "rgba(16,185,129,0.1)", borderRadius: 6, color: MINT, fontWeight: 600, fontSize: 13 } }, "\u2193 ", pctReduction, "% variance"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 14 } }, /* @__PURE__ */ React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 13 } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: cupedOn, onChange: (e) => setCupedOn(e.target.checked) }), "Apply CUPED"))), /* @__PURE__ */ React.createElement("div", { style: { flex: "2 1 280px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: INK3, marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.08em" } }, cupedOn ? "CUPED-adjusted metric (narrower CIs)" : "Raw metric (wide CIs)"), /* @__PURE__ */ React.createElement("svg", { width: "100%", viewBox: `0 0 ${W} ${H + 20}`, style: { overflow: "visible" } }, barsData.map((b, i) => {
  ...
  function PowerCalculator() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      ].map(({ label, val, min, max, step, fmt, set }) => /* @__PURE__ */ React.createElement("div", { key: label, style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#d1d5db" } }, label), /* @__PURE__ */ React.createElement("span", { style: { color: "#f1f5f9", fontWeight: 600 } }, fmt(val))), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "range",
          min,
