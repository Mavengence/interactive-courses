(() => {
  ...
  function TopBar({ chapter, onPrev, onNext, prevDisabled, nextDisabled }) {
    return /* @__PURE__ */ React.createElement("div", { className: "tb" }, /* @__PURE__ */ React.createElement("div", { className: "crumb" }, /* @__PURE__ */ React.createElement("b", null, "DS Fundamentals"), /* @__PURE__ */ React.createElement("span", { className: "sep" }, "/"), /* @__PURE__ */ React.createElement("span", null, "Ch ", chapter.n), /* @__PURE__ */ React.createElement("span", { className: "sep" }, "/"), /* @__PURE__ */ React.createElement("span", { className: "here" }, chapter.title)), /* @__PURE__ */ React.createElement("div", { className: "tb-right" }, /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: onPrev, disabled: prevDisabled }, "\u2190 Prev ", /* @__PURE__ */ React.createElement("span", { className: "kbd" }, "\u2190")), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: onNext, disabled: nextDisabled }, "Next \u2192 ", /* @__PURE__ */ React.createElement("span", { className: "kbd" }, "\u2192"))));
  }
  function App() {
