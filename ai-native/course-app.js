...
function Sidebar({ route, progress }) {
  ...
  return /* @__PURE__ */ React.createElement("aside", { className: "crs-side" }, /* @__PURE__ */ React.createElement("a", { href: "../", className: "crs-side__back" }, /* @__PURE__ */ React.createElement("span", { className: "crs-side__back-arrow", "aria-hidden": "true" }, "←"), "All courses"), /* @__PURE__ */ React.createElement("div", { className: "crs-side__brand" }, /* @__PURE__ */ React.createElement("div", { className: "crs-side__edition" }, COURSE_META.cohort), /* @__PURE__ */ React.createElement("div", { className: "crs-side__title" }, COURSE_META.title)), /* @__PURE__ */ React.createElement("a", { href: link.home(), className: "crs-side__home" + (route.route === "home" ? " is-active" : "") }, "Course overview"), /* @__PURE__ */ React.createElement("div", { className: "crs-side__section" }, "Modules"), MODULES.map((m) => {
