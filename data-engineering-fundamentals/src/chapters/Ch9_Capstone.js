(() => {
  ...
  const STAGES = [
    { k: "merge", n: "01", ref: "Ch03 \xB7 Store", title: "Cumulative merge", sub: "FULL OUTER JOIN yesterday \u2295 today", color: "#7C5CFF" },
    { k: "write", n: "02", ref: "Ch05 \xB7 Orchestrate", title: "Idempotent write", sub: "INSERT OVERWRITE partition ds", color: "#2D7DFF" },
    { k: "watermark", n: "03", ref: "Ch02 \xB7 Streaming", title: "Watermark + dedup", sub: "ROW_NUMBER \xB7 event_ts \u2265 ds", color: "#22D3EE" },
    { k: "dq", n: "04", ref: "Ch06 \xB7 Quality", title: "Data-quality gate", sub: "row-count \xB7 freshness \xB7 unique", color: "#31A24C" },
    { k: "govern", n: "05", ref: "Ch09 \xB7 Govern", title: "Access Gateway deploy", sub: "PII actors \xB7 data_classification", color: "#B8770A" },
    { k: "semantic", n: "06", ref: "Ch08 \xB7 Serve", title: "Semantic binding", sub: "metric \u2192 physical column", color: "#E41E3F" }
  ];
  const USER_POOL = [
    // active — normal flow
