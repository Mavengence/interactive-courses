(() => {
  ...
  function CumulativeSim() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "ctl-row" }, /* @__PURE__ */ React.createElement("div", { className: "ctl-slider", style: { flex: 2 } }, /* @__PURE__ */ React.createElement("div", { className: "row" }, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Scrub day"), /* @__PURE__ */ React.createElement("span", { className: "val" }, "Day ", day + 1)), /* @__PURE__ */ React.createElement("input", { type: "range", min: 0, max: 4, step: 1, value: day, onChange: (e) => setDay(+e.target.value) }), /* @__PURE__ */ React.createElement("span", { className: "hint" }, "click a day card above, or drag here")), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", disabled: patched, onClick: startBackfill }, patched ? `\u2713 Backfilled from Day ${bugDay + 1}` : `Patch & backfill from Day ${bugDay + 1}`))
    );
  }
